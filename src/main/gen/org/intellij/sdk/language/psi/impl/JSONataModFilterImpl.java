...
public class JSONataModFilterImpl extends ASTWrapperPsiElement implements JSONataModFilter {

  public JSONataModFilterImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JSONataVisitor visitor) {
    visitor.visitModFilter(this);
  }
