...
public class JSONataFuncWordImpl extends ASTWrapperPsiElement implements JSONataFuncWord {

  public JSONataFuncWordImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JSONataVisitor visitor) {
    visitor.visitFuncWord(this);
  }
