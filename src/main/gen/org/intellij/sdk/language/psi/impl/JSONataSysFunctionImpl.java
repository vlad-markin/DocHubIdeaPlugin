...
public class JSONataSysFunctionImpl extends ASTWrapperPsiElement implements JSONataSysFunction {

  public JSONataSysFunctionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JSONataVisitor visitor) {
    visitor.visitSysFunction(this);
  }
