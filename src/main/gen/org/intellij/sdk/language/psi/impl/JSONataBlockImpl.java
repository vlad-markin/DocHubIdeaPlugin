...
public class JSONataBlockImpl extends ASTWrapperPsiElement implements JSONataBlock {

  public JSONataBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public JSONataBlockBody getBlockBody() {
    return findChildByClass(JSONataBlockBody.class);
  }
