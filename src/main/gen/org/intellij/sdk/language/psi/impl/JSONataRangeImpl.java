...
public class JSONataRangeImpl extends ASTWrapperPsiElement implements JSONataRange {

  public JSONataRangeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public JSONataSysFunction getSysFunction() {
    return findChildByClass(JSONataSysFunction.class);
  }
