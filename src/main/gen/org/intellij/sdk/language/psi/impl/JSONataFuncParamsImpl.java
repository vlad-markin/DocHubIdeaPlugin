...
public class JSONataFuncParamsImpl extends ASTWrapperPsiElement implements JSONataFuncParams {

  public JSONataFuncParamsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JSONataVisitor visitor) {
    visitor.visitFuncParams(this);
  }
