...
public class JSONataModBindSelfImpl extends ASTWrapperPsiElement implements JSONataModBindSelf {

  public JSONataModBindSelfImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JSONataVisitor visitor) {
    visitor.visitModBindSelf(this);
  }
