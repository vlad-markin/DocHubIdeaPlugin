...
public class JSONataChainSimpleImpl extends ASTWrapperPsiElement implements JSONataChainSimple {

  public JSONataChainSimpleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JSONataVisitor visitor) {
    visitor.visitChainSimple(this);
  }
