...
public class JSONataModBindIndexImpl extends ASTWrapperPsiElement implements JSONataModBindIndex {

  public JSONataModBindIndexImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JSONataVisitor visitor) {
    visitor.visitModBindIndex(this);
  }
