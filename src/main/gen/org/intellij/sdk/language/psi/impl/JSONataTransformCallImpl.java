...
public class JSONataTransformCallImpl extends ASTWrapperPsiElement implements JSONataTransformCall {

  public JSONataTransformCallImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JSONataVisitor visitor) {
    visitor.visitTransformCall(this);
  }
