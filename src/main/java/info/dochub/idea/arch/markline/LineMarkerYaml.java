...
import info.dochub.idea.arch.references.providers.RefAspectID;
import info.dochub.idea.arch.references.providers.RefComponentID;
import info.dochub.idea.arch.references.providers.RefContextID;
import info.dochub.idea.arch.references.providers.RefDocsID;
...
import static info.dochub.idea.arch.markline.LineMarkerNavigator.*;
