package info.dochub.idea.arch.completions.providers.technologies;

import com.intellij.patterns.ElementPattern;
import com.intellij.patterns.PlatformPatterns;
import com.intellij.psi.PsiElement;
import info.dochub.idea.arch.completions.CompletionKey;
import info.dochub.idea.arch.completions.providers.FilteredCustomProvider;
import info.dochub.idea.arch.completions.providers.Technologies;
...
public class ItemsItem extends FilteredCustomProvider {
    private static String keyword = "items";

    private static final Collection<CompletionKey> COMPLETION_KEYS = List.of(new CompletionKey("title"));
