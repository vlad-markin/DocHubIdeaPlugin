...
import info.dochub.idea.arch.jsonschema.EntityManager;
import info.dochub.idea.arch.manifests.PlantUMLDriver;
import info.dochub.idea.arch.settings.SettingsState;
import info.dochub.idea.arch.wizard.RootManifest;
import org.apache.commons.io.*;
import org.apache.http.client.utils.URIBuilder;
import info.dochub.idea.arch.indexing.*;
import info.dochub.idea.arch.jsonschema.*;
import info.dochub.idea.arch.manifests.*;
import info.dochub.idea.arch.settings.*;
import info.dochub.idea.arch.wizard.*;
...
import static info.dochub.idea.arch.tools.Consts.*;
