...
import info.dochub.idea.arch.references.providers.RefBaseID;
import info.dochub.idea.arch.indexing.CacheBuilder;
import info.dochub.idea.arch.utils.VirtualFileSystemUtils;

import java.util.ArrayList;
import java.util.Map;

import static info.dochub.idea.arch.tools.Consts.ROOT_SOURCE_PATH;
import static info.dochub.idea.arch.tools.Consts.ROOT_SOURCE_URI;
